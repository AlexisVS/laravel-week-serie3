  ...
  <div class="row min-vh-100">
    ...
    <div class="col-12 col-md-4 col-lg-3 col-xl-2 bg-dark text-white">
      <nav class="d-flex flex-column align-items-center text-white text-decoration-none">
        ...
        <a class="text-white text-decoration-none fs-4" href="/administration/services">Services</a>
        <a class="text-white text-decoration-none fs-4" href="/administration/portfolio">Portfolio</a>
      </nav>
    </div>
    {{-- body --}}
